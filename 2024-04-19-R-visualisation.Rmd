...
`https://github.com/ELIXIREstonia/2024-04-19-R-visualisation`.
...
This is second part of a two part curriculum to get started with R and ggplot2.
If you are unfamiliar with R basic syntax, datatypes and tidyverse, then first
